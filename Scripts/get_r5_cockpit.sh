...
RAW_OUT="/config/renault/debug_cockpit_raw.txt"
CACHE_JSON="/config/renault/cockpit_cache.json"
...
URL="/commerce/v1/accounts/${KAM_ACCOUNT_ID}/kamereon/kca/car-adapter/v1/cars/${VIN}/cockpit?country=GB&brand=RENAULT"
...
RAW_OUT = Path("/config/renault/debug_cockpit_raw.txt")
CACHE_JSON = Path("/config/renault/cockpit_cache.json")
VIN = "<your-vin-number>"
